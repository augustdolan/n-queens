...
*/
  ...
  // input number (size and pieces)

  // output num of boards where n rooks don't attack e/o

  // key pieces
    // n
    // iterate over whole board
    // var to store count of boards
    // need some comparison to ensure array hasn't been previously generated
    // need way to make movement
      // find nRooks finds A solution
      // find way to dynamically generate newly forced positions

  // given any n this functionw will find any number of board states of n rooks that don't attack eachother

  // how decision tree
    // if i is the same or j is the same as a placed piece, can't place a new piece
    // each space represented by i/j indicies
    // 2^^2
    //
